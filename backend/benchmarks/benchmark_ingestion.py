...
from app.embedders.factory import get_embedding_provider, get_reranker, get_sparse_provider
...
async def run_benchmarks():
    if not CORPUS_DIR.exists():
        logger.error(f"Corpus directory {CORPUS_DIR} not found. Run generate_corpus.py first.")
        return
